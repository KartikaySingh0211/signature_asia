	...
	return (
		<section className="py-16 cursor-default">
			<div className="max-w-full mx-auto px-4 sm:px-6 lg:px-30">
				...
				{/* Three Column Layout */}
				<div className="grid lg:grid-cols-3 gap-8 lg:gap-20">
					...
					<div className="text-center">
						...
						<div className="flex flex-col items-center justify-center p-6  rounded-lg hover:shadow-lg transition-shadow duration-300">
							...
							<h3 className="text-xl md:text-3xl font-medium text-[#417849] mb-4">
								Expertise in Pesticides and Insecticides
							</h3>
							<p className="text-[#623E15] font-semibold mb-6 leading-relaxed">
					...
					<div className="text-center  p-6 rounded-lg hover:shadow-lg transition-shadow duration-300 pt-28">
						...
						<p className="text-[#623E15] mb-6 font-semibold leading-relaxed">
					...
					<div className="text-center ">
						...
						<div className="flex flex-col  items-center justify-center p-6 rounded-lg hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-[#623E15] font-semibold leading-relaxed">
